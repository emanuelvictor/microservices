...
import com.emanuelvictor.api.functional.vehiclefinancingsimulatorsapi.infrastructure.browser.chromeutils.ChromeDriverBuilder;
...
//        chrome_options.addArguments("--headless=chrome"); // when chromedriver <= 108.x.x.x
        ...
        LOGGER.info("urlOfTheBrowserInstance: " + urlOfTheBrowserInstance);
        LOGGER.info("sessionId: " + sessionId);
        LOGGER.info("urlOfFirstTab: " + urlOfFirstTab);
