...
public class ModelTests {
    ...
    private static Stream<Arguments> getInvalidData() {
        ...
        return Stream.of(
                Arguments.arguments(null, brand, Model.INVALID_MODEL_NAME_MESSAGE),
                Arguments.arguments("", brand, Model.INVALID_MODEL_NAME_MESSAGE),
                Arguments.arguments("", null, Model.INVALID_BRAND_MESSAGE)
        );
    }
}
